...
console.log('Donne les coordonnées x et y de ton point A, sépare les deux valeurs juste par un espace.');
let coPointA = readline.question();
let [coPointAX, coPointAY] = coPointA.split(' ');

console.log('Donne les coordonnées x et y de ton point B, sépare les deux valeurs juste par un espace.');
...
let distanceX : number = 0, distanceY : number = 0;
